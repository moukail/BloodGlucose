...
public class NumberPicker extends LinearLayout {
    ...
    private static int TEXT_COLOR_LABEL = 0xff008AE5;
...
//        mSoundId = mSoundPlayer.load(getContext(), R.raw.numberpicker_value_change, 1);
        ...
        mLabelPaint.setColor(TEXT_COLOR_LABEL);
     ...
     * <p>
     * If the argument is less than the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMinValue()} and
     * {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMinValue()} and
     * {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMaxValue()} and
     * {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMaxValue()} value.
     * </p>
     * <p>
    ...
    private void tryComputeMaxWidth() {
        ...
        if (mDisplayedValues == null) {
            ...
            for (int i = 0; i < count; ++i) {
                String text = mDisplayedValues[i];
     ...
     * wrap around the {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMinValue()} and
     * {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker#getMaxValue()} values.
     * <p>
...
//        mSoundPlayer.release();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (posy < 1) {
                mSelectorWheelPaint.setColor(getAlphaGradient(posy, TEXT_COLOR_LABEL/*TEXT_COLOR_FG*/, true));
                canvas.drawText(scrollSelectorValue, x, y + (sizeFg - TEXT_SIZE_MIN) / 2.0f, mSelectorWheelPaint);
            }
...
//        mSoundPlayer.play(mSoundId, 1, 1, 0, 0, 1);
    ...
    /**
     * Posts an {@link com.ihealth.ciforbg.view.switchbutton.TimerPicker.NumberPicker.SetSelectionCommand} from the given <code>selectionStart
